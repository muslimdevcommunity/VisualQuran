...
//         this.setState({
//           selectData: { ...this.state.selectData, chapters: initialChapters }
//         });
//       })
//       .catch((error) => {
//         console.log(error);
...
//     if (
//       this.state.settings.currentChapterId &&
//       this.state.settings.currentRecitationId &&
//       this.state.settings.currentTranslationId
//     ) {
//       if (
//         !this.state.apiData ||
//         (this.state.apiData &&
//           (this.state.changedChapter ||
//             this.state.changedRecitation ||
//             this.state.changedTranslation ||
...
//             }&translations=${
//               this.state.settings.currentTranslationId
//             }&language=en&text_type=words&page=${
//               this.state.changedChapter ? 1 : this.state.currentPage
//             }`
//           )
//           .then((response) => {
//             this.setState({
...
//       } else if (
//         this.state.currentVerseCount === apiData.verses.length - 1 &&
...
//         this.setState({ currentVerseCount: currVerse - 1 });
//       } else if (
//         this.state.currentVerseCount === 0 &&
//         !apiData.meta.prev_page
//       ) {
//         console.log(!apiData.meta.next_page);
...
//     } else {
//       alert(
//         "Please Choose a chapter,recitation and translation before you proceed to play"
//       );
//     }
...
//           settings: {
//             ...this.state.settings,
//             currentChapterId: currentSetting
//           },
//           changedChapter: true
//         });
//         break;
...
//           settings: {
//             ...this.state.settings,
//             currentRecitationId: currentSetting
//           },
//           changedRecitation: true
//         });
//         break;
...
//           settings: {
//             ...this.state.settings,
//             currentTranslationId: currentSetting
//           },
...
//     let quranVerse = (
//       <QuranVerse
//         arabicVerse='Pleas Select A chapter'
//         translationVerse='Please Select a translation'
//       >
//         {" "}
//       </QuranVerse>
//     );
...
//     ) {
//       quranVerse = (
//         <QuranVerse arabicVerse='Loading...' translationVerse='Loading...'>
//           {" "}
//         </QuranVerse>
//       );
//     }
...
//           ref={this.currentAudio}
//           controls
//           autoPlay
//           key={
//             this.state.apiData.verses[this.state.currentVerseCount].audio.url
//           }
//         >
//           <source
//             src={
...
//         <QuranVerse
//           currentVerse={
//             this.state.apiData.verses[this.state.currentVerseCount].verse_key
//           }
//           arabicVerse={
//             this.state.apiData.verses[this.state.currentVerseCount].text_madani
//           }
//           translationVerse={
//             this.state.apiData.verses[this.state.currentVerseCount]
//               .translations[0].text
//           }
//         >
//           {" "}
...
//         <Modal>
//           <Controller
//             currPlay={this.state.play}
//             onPlay={this.onChangePlay}
//             currentCheck={this.state.repeat}
//             currentSettings={this.state.settings}
//             nextChapter={this.nextChapterHandler}
//             prevChapter={this.previousChapterHandler}
//             onRepeat={this.onRepeatHandle}
//             settings={this.onChangeSettings}
//             imgURL={this.state.gallery.imgURL}
//             changeBackground={this.onChangeBackground}
